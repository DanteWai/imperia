...
/* harmony import */ var _servers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./servers */ "./resources/js/admin/servers.js");
/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tabs */ "./resources/js/admin/tabs.js");
/* harmony import */ var _components_priceToParse__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/priceToParse */ "./resources/js/admin/components/priceToParse.js");
...
window.addEventListener('load', function () {
  var priceParse = new _components_priceToParse__WEBPACK_IMPORTED_MODULE_5__["PriceToParse"]('parse');
  new _tabs__WEBPACK_IMPORTED_MODULE_4__["default"]({
    parent: '.tabs-contaiter'
  });
  var server = new _servers__WEBPACK_IMPORTED_MODULE_3__["default"](); // Вешаем на файловые инпуты обработку текста

  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.inputFile').on('change', function () {
    this.nextElementSibling.innerHTML = this.value.substr(this.value.lastIndexOf("\\") + 1, this.length);
  });
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.category_selector').on('change', function () {
    server.get(this.dataset.href + '?id=' + this.value, {
      'X-CSRF-TOKEN': jquery__WEBPACK_IMPORTED_MODULE_1___default()('input[name="_token"]').val(),
      "X-Requested-With": "XMLHttpRequest"
    }).then(function (answer) {
      console.log(answer);

      if (answer.html) {
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.product-options').html(answer.html);
      }
    });
  });
});
